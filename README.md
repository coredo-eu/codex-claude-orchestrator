...
`status` reports live admitted `busy` capacity separately from durable
...
safely tombstone; `blocked_roots` includes both open states.
...
Version `0.4.0` retains runtime schema 4 as the legacy parent-stage health
